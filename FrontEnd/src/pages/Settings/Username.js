...
class EnhancedForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      username: props.AccountStore.me.username,
    }
  }
  ...
  handleSubmit = (values, {props, setFieldError, setSubmitting, setStatus}) => {
    ...
    try {
      this.props.AccountStore.me.changeUsername(values.username)
    ...
    return (
      <div className="row justify-content-md-center">
        <Formik component={FormikForm}
                ...
                initialValues={{username: this.props.AccountStore.me.username}}
